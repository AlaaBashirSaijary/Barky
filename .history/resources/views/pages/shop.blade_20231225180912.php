	...
	<div class="container">
		<div class="row">
				...
				<div class="product-item col-md-3 pb-4">
					<a href="{{ route('singleproudctid',[$product->id]) }}" class="product-image"><img src="images/{{ $product->image  }}"></a>
					<div class="text-comtent text-center">
						<h5 class="pt-4"><a href="{{ route('singleproudct',[$product->id]) }}">{{ $product->type  }}</a></h5>
