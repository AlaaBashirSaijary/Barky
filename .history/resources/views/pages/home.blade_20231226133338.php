	...
	<div class="container">
		...
		<div class="d-flex products-slider">
				...
				<div class="product-item col-md-3 pl-0">
					<a href="{{ route('singleproudctid',[1]) }}"class="product-image"><img src="images/cake-item1.jpg"></a>
					<div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href="{{ route('singleproudctid',[1]) }}">Black Forest Pastry</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
				<div class="product-item col-md-3 pl-0">
					<a href="{{ route('singleproudctid',[1]) }}" class="product-image"><img src="images/cake-item2.jpg"></a>
					<div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href="{{ route('singleproudctid',[1]) }}">Sprinkled Donuts</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
				<div class="product-item col-md-3 pl-0">
					<a href="{{ route('singleproudctid',[1]) }}" class="product-image"><img src="images/cake-item3.jpg"></a>
					<div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href="{{ route('singleproudctid',[1]) }}">Black Forest Cupcake</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
				<div class="product-item col-md-3 pl-0">
					<a href="{{ route('singleproudctid',[1]) }}"class="product-image"><img src="images/cake-item4.jpg"></a>
				    <div class="text-comtent text-center text-hover">
				...
				<div class="product-item col-md-3 pl-0">
					<a href="{{ route('singleproudctid',[1]) }}" class="product-image"><img src="images/cake-item1.jpg"></a>
				    <div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href="{{ route('singleproudctid',[1]) }}">Macarons with Berries</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="pix_btn text-center m-auto">
				<a href="{{ route('Shop') }}" class="btn-hvr-effects mt-3">View All</a>
			</div>
		</div>
	</div>
</section>
...
<section class="latest-blogs margin-medium">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 left-post pl-0 mb-3">
				...
				<a href="{{ route('singleproudctid',[1]) }}"><img src="images/postImg1.jpg" alt="cake" class="largeImg"></a>
				<div class="content light">
					<span class="highlight">March 10, 2024</span>
					<h3 class="mt-3"><a href="{{ route('singleproudctid',[1]) }}">How to Make a Cake with Great Delicious Chocolate</a></h3>
				</div>
				</div>
			</div>
			...
			<div class="col-md-6 right-post pl-0">
				<div class="post-content mb-3">
					<a href="{{ route('singleproudctid',[1]) }}"><img src="images/postLong.jpg" alt="cake" class="horizontalImg"></a>
					<div class="content light">
						<span class="highlight">March 10, 2024</span>
						<h3 class="mt-3"><a href={{ route("singlepost") }}>How to Make a Cake with Great Delicious Chocolate</a></h3>
					</div>
				</div><!--post-->

				<div class="post-content">
					<a href={{ route("singlepost") }}><img src="images/postLong.jpg" alt="cake" class="horizontalImg"></a>
					<div class="content light">
						<span class="highlight">March 10, 2024</span>
						<h3 class="mt-3"><a href={{ route("singlepost") }}>How to Make a Cake with Great Delicious Chocolate</a></h3>
					</div>
	...
	<div class="pix_btn text-center">
		<a href="{{ route('Blog') }}" class="btn-hvr-effects mt-5">read more</a>
	</div>
</section>
