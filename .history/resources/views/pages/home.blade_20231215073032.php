	...
	<div class="container">
		...
		<div class="d-flex products-slider">
				...
				<div class="product-item col-md-3 pl-0">
					<a href={{ route("singleproduct") }}class="product-image"><img src="images/cake-item1.jpg"></a>
					<div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href={{ route("singleproduct") }}>Black Forest Pastry</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
				<div class="product-item col-md-3 pl-0">
					<a href={{ route("singleproduct") }} class="product-image"><img src="images/cake-item2.jpg"></a>
					<div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href={{ route("singleproduct") }}>Sprinkled Donuts</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
				<div class="product-item col-md-3 pl-0">
					<a href={{ route("singleproduct") }} class="product-image"><img src="images/cake-item3.jpg"></a>
					<div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href={{ route("singleproduct") }}>Black Forest Cupcake</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
