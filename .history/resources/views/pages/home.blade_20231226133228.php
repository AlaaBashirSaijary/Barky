...
<section class="best-products margin-large">
	<div class="container">
		...
		<div class="d-flex products-slider">
				...
				<div class="product-item col-md-3 pl-0">
					<a href={{ route("singleproudct") }} class="product-image"><img src="images/cake-item1.jpg"></a>
				    <div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href={{ route("singleproudct") }}>Macarons with Berries</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 left-post pl-0 mb-3">
				...
				<a href={{ route("singlepost") }}><img src="images/postImg1.jpg" alt="cake" class="largeImg"></a>
