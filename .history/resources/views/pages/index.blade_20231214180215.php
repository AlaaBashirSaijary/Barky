	...
	<div class="container">
		...
		<div class="d-flex products-slider">
				...
				<div class="product-item col-md-3 pl-0">
					<a href="single-product.html" class="product-image"><img src={{ asset("images/cake-item1.jpg") }}></a>
				...
				<div class="product-item col-md-3 pl-0">
					<a href="single-product.html" class="product-image"><img src={{ asset("images/cake-item2.jpg") }}></a>
					<div class="text-comtent text-center text-hover">
				...
				<div class="product-item col-md-3 pl-0">
					<a href="single-product.html" class="product-image"><img src={{ asset("images/cake-item3.jpg") }}></a>
					<div class="text-comtent text-center text-hover">
				...
				<div class="product-item col-md-3 pl-0">
					<a href="single-product.html" class="product-image"><img src={{ asset("images/cake-item4.jpg") }}></a>
				    <div class="text-comtent text-center text-hover">
...
#main-wrapper > section.special-items.mb-5
		...
		<div class="row">
			<div class="d-flex flex-wrap col-md-12">
				<figure class="col-md-4 mb-3 pl-0">
					<a class="magnific-popup" href={{ asset("images/blackforest.jpg") }}>
						<img src={{ asset("images/blackforest.jpg") }} alt="cake" class="galleryImg">
						<div class="overlay">
				...
				<figure class="col-md-4 mb-3 pl-0">
					<a class="magnific-popup" href={{ asset("images/macarons.jpg") }}>
						<img src={{ asset("images/macarons.jpg") }} alt="cake" class="galleryImg">
						<div class="overlay">
							<i class="icon icon-search-plus"></i>
						</div><!--imgOverlay-->
					</a>
				...
				<figure class="col-md-4 mb-3 pl-0">
					<a class="magnific-popup" href={{ asset("images/cakeitem.jpg") }}>
						<img src={{asset("images/blackforest.jpg")  }} alt="cake" class="galleryImg">
						<div class="overlay">
							<i class="icon icon-search-plus"></i>
						</div><!--imgOverlay-->
				...
				<figure class="col-md-4 mb-3 pl-0">
					<a class="magnific-popup" href={{ asset("images/sprinkleddonuts.jpg") }}>
						<img src={{ asset("images/sprinkleddonuts.jpg" ) }}alt="cake" class="galleryImg">
						<div class="overlay">
							<i class="icon icon-search-plus"></i>
						</div><!--imgOverlay-->
					</a>
			...
			<div class="testimonial-slider">
				<div class="testimonials-inner">
					...
					<div class="testimonial-author">
						<img src={{asset("images/default.png")  }} alt="jane">
				...
				<div class="testimonials-inner">
					...
					<div class="testimonial-author">
						<img src={{ asset("images/default.png") }} alt="simran">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 left-post pl-0 mb-3">
				...
				<a href="single-post.html"><img src={{ asset("images/postImg1.jpg") }} alt="cake" class="largeImg"></a>
			...
			<div class="col-md-6 right-post pl-0">
				<div class="post-content mb-3">
					<a href="single-post.html"><img src={{ asset("images/postLong.jpg") }} alt="cake" class="horizontalImg"></a>
					<div class="content light">
						<span class="highlight">March 10, 2020</span>
						<h3 class="mt-3"><a href="single-post.html">How to Make a Cake with Great Delicious Chocolate</a></h3>
					</div>
		...
		<div class="row">
			<div class="col-md-12">
				<ul class="d-flex list-unstyled justify-content-between flex-wrap">
					<li><a href="#"><img src={{ asset("images/baker.svg" ) }}class="brandImg"></a></li>
					<li><a href="#"><img src={{ asset("images/bakery.svg") }} class="brandImg"></a></li>
					<li><a href="#"><img src={{ asset("images/thebakery.svg") }} class="brandImg"></a></li>
					<li><a href="#"><img src={{ asset("images/breadcookies.svg") }} class="brandImg"></a></li>
					<li><a href="#"><img src={{ asset("images/bakery.svg") }} class="brandImg"></a></li>
				</ul>
			</div>
		</div>
