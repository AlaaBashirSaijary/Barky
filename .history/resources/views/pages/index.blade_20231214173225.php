		...
		<div class="row">
			<div class="col-md-12">
				<ul class="d-flex list-unstyled justify-content-between flex-wrap">
					<li><a href="#"><img src=ass"images/baker.svg" class="brandImg"></a></li>
					<li><a href="#"><img src=ass"images/bakery.svg" class="brandImg"></a></li>
					<li><a href="#"><img src=ass"images/thebakery.svg" class="brandImg"></a></li>
					<li><a href="#"><img src=ass"images/breadcookies.svg" class="brandImg"></a></li>
					<li><a href="#"><img src=ass"images/bakery.svg" class="brandImg"></a></li>
				</ul>
			</div>
		</div>
