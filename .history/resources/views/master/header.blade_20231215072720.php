						...
						<ul class="navbar-nav list-inline text-uppercase">
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href={{ route("About") }}"single-post.html" class="dropdown-item">Single Post</a></li>
									<li><a href={{ route("About") }}"contact.html" class="dropdown-item">Contact us</a></li>
									<li><a href={{ route("About") }}"shop.html" class="dropdown-item">Shop</a></li>
									<li><a href={{ route("single-product") }}"single-product.html" class="dropdown-item">Single Product</a></li>
								</ul>
							</li>
