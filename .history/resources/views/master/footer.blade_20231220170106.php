				...
				<div class="quick-links">
					...
					<div class="footer-menu">
						<ul class="list-unstyled">
							...
							<li><a href="{{ route("singleproudct") }}">Gallery</a></li>
...
<div class="footer-bottom">
	<div class="container">
		<div class="wrap flex-container padding-small">
			<div class="copyright">
				<p class="mb-0">© 2024 Bakery HTML Template by <a href="https://templatesjungle.com/" target="_blank">Templates Jungle</a></p>
			</div>
			<div class="payment-card">
				<span>We Accept:</span>
				<img src='{{asset("images/visa.png")  }}' class="cardImg">
				<img src='{{asset("images/american-express.png")  }}' class="cardImg">
				<img src='{{asset("images/master-card.png")  }}' class="cardImg">
			</div>
		</div>
	</div>
</div>
