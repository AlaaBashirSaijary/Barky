						...
						<ul class="navbar-nav list-inline text-uppercase">
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href={{ route("singlepost") }} class="dropdown-item">Single Post</a></li>
                                    <li><a href={{ route("singlepost") }} class="dropdown-item">Shop</a></li>
									<li><a href={{ route("Contact") }}class="dropdown-item">Contact us</a></li>
									<li><a href={{ route("singleproudct") }} class="dropdown-item">Single Product</a></li>
								</ul>
							</li>
